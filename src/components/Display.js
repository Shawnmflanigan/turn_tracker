...
export default function Display({ faction, faction2, p1Secondary1, p1Secondary2, p1Secondary3 }) {
  console.log(`Faction 1 is ${faction.label}`);
  console.log(`Faction 2 is ${faction2.label}`);
  console.log(`Player one Secondaries are ${p1Secondary1.label}, ${p1Secondary2.label}, & ${p1Secondary3.label}`);
  ...
  return (
    <div>
      ...
      <div class="col col2">
        ...
        <Turn />
         {faction.label}: {primary1} vs {faction2.label}: {primary2}
      </div>
